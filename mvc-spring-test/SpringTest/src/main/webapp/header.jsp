...
<link rel="stylesheet" type="text/css" href="${path}/resources/css/hom.css"/>
  ...
  <div class="content mt-4" >
      ...
      <div class="content-fixed top" style="margin-bottom: 0px;">
        <ul class="Menu1" style="margin-bottom: 0px;">
          <li class="dropbox">
            <a href="getCommodityList.jsp">전시문화</a>
            <span class="dropmenu">
              <a href="#">특별전</a>
              <a href="#">전문전</a>
              <a href="#">역사전</a>
          ...
          <li class="dropbox">
            <a href="#">활동</a>
            <span class="dropmenu">
              <a href="http://wwww.naver.com">예술</a>
              <a href="#">도구정보</a>
            </span>
          </li>
        ...
        <ul class="Menu1" style="margin-bottom: 0px;">
          <li class="dropbox2 "><a href="login.do"> 로그인 </a></li>
